...
export const exploratoryLearningV2ExecutionPackPins = Object.freeze({
...
const requiredRepositoryPaths = new Map([
  ...
  [
    "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/fixtures/negative",
    "directory",
  ],
  ...
  ["rfcs", "directory"],
  ["runtime", "directory"],
  ["runtime/experimental/owner-facing-workbench-v1", "directory"],
  ["runtime/experimental/owner-facing-workbench-v1/EPISODE.md", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/FORMAT.md", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/README.md", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/RELEASE-CANDIDATE.json", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/STATUS.md", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/cli.mjs", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/core.mjs", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/core.test.mjs", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/qualify.mjs", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/release-candidate.test.mjs", "file"],
  ["runtime/experimental/owner-facing-workbench-v1/verify-release-candidate.mjs", "file"],
  ["schemas", "directory"],
  ["spec", "directory"],
  ["tooling", "directory"],
  ...
  ["tooling/author-call-result-schema-learning-v2", "file"],
  ["tooling/author-call-result-schema-learning-v2.mjs", "file"],
  ["tooling/author-call-result-schema-learning-v2-validator.mjs", "file"],
  ["tooling/author-call-result-schema-learning-v2-verifier.mjs", "file"],
  ["tooling/author-call-result-schema-learning-v2.test.mjs", "file"],
...
async function checkExploratoryLearningV2ExecutionPack() {
  try {
    await verifyCheckedInV2Audit(
      exploratoryLearningV2ExecutionPackPins.manifestSha256,
      exploratoryLearningV2ExecutionPackPins.auditResultSha256,
    );
  } catch (error) {
    const codes =
      error instanceof ExecutionPackV2VerificationError
        ? error.codes.join(",")
        : "unexpected-failure";
    report(`exploratory-learning v2 execution pack rejected (${codes})`);
  }
}
