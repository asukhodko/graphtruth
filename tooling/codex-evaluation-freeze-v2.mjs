...
export const evaluationContractKind = "graphtruth.evaluation-contract/2";
export const evaluationAuditKind = "graphtruth.evaluation-freeze-audit/2";
export const evaluationReleaseKind = "graphtruth.evaluation-freeze-release/2";
...
export const evaluationV2PreparationRecord =
  "https://github.com/asukhodko/graphtruth/issues/24#issuecomment-5047992832";
const nonAuthorizingRecords = Object.freeze([
  "https://github.com/asukhodko/graphtruth/issues/24#issuecomment-5033460564",
  evaluationV2PreparationRecord,
]);
...
export const resultClassIds = Object.freeze([
  "correct",
  "partial",
  "incorrect",
  "correct-abstention",
...
export const resultClassPrecedence = Object.freeze([
  "contaminated",
  "invalid",
  "interrupted",
  "timeout",
...
export const captureTaxActivityIds = Object.freeze([
  "capture",
  "annotation",
  "correction",
  "maintenance",
...
export const auditIssueCodesByChecklist = Object.freeze({
  "identity-and-inputs": Object.freeze([
    "identity-mismatch", "input-anchor-mismatch",
  ]),
  "hypothesis-boundary": Object.freeze(["hypothesis-boundary-invalid"]),
  "temporal-model": Object.freeze(["temporal-model-invalid"]),
  "task-coverage-and-denominator": Object.freeze([
    "task-coverage-invalid", "denominator-invalid",
  ]),
  "oracle-and-rubric": Object.freeze([
    "oracle-isolation-invalid", "result-classes-not-fully-defined",
    "rubric-incoherent",
  ]),
  "baseline-parity": Object.freeze([
    "baseline-parity-invalid", "graphtruth-capture-tax-rule-missing",
  ]),
  "roles-and-first-exposure": Object.freeze([
    "role-conflict", "first-exposure-invalid",
  ]),
  "numeric-budgets-and-failures": Object.freeze([
    "numeric-budget-invalid", "failure-handling-invalid",
  ]),
  "severe-errors": Object.freeze(["severe-errors-invalid"]),
  "sequential-decision-rules": Object.freeze(["decision-rules-invalid"]),
  "no-run-boundary": Object.freeze(["run-boundary-violated"]),
});

export const expectedResultClassification = Object.freeze({
  assignment: "first-matching-rule-in-precedence-order",
  precedence: resultClassPrecedence,
  exactlyOneClassPerCell: true,
  mutuallyExclusiveByPrecedence: true,
  exhaustiveWithFallback: true,
  fallbackClass: "incorrect",
  classifierInputs: Object.freeze([
    "contamination-detected",
    "protocol-invalidity-detected",
    "attempt-started",
    "attempt-interrupted",
    "answer-deadline-reached",
    "hard-timeout-reached",
    "valid-answer-submitted",
    "required-disposition",
    "mandatory-elements-satisfied",
    "forbidden-elements-present",
    "severe-error-triggered",
  ]),
  rules: Object.freeze({
    correct: Object.freeze({
      predicate:
        "timely-valid-answer-or-revision-all-mandatory-no-forbidden-no-severe",
      category: "substantive-success",
      cellSuccess: true,
      scoreEffect: "score-by-frozen-dimensions",
      denominatorRule: "retain",
      timeRule: "elapsed-presentation-to-valid-submission",
      taskAggregation: "successful-cell",
      severeErrorRelation: "cannot-match-when-severe-error-triggered",
      decisionEffect: "eligible-for-keep",
    }),
    partial: Object.freeze({
      predicate:
        "timely-valid-at-least-one-mandatory-and-at-least-one-missing-no-forbidden-no-severe",
      category: "substantive-failure",
      cellSuccess: false,
      scoreEffect: "score-by-frozen-dimensions",
      denominatorRule: "retain",
      timeRule: "elapsed-presentation-to-valid-submission",
      taskAggregation: "failed-cell",
      severeErrorRelation: "cannot-match-when-severe-error-triggered",
      decisionEffect: "block-this-arm-task-success",
    }),
    incorrect: Object.freeze({
      predicate: "fallback-for-timely-valid-substantive-answer",
      category: "substantive-failure",
      cellSuccess: false,
      scoreEffect: "score-by-frozen-dimensions",
      denominatorRule: "retain",
      timeRule: "elapsed-presentation-to-valid-submission",
      taskAggregation: "failed-cell",
      severeErrorRelation: "declared-severe-error-consequence-also-applies",
      decisionEffect: "block-this-arm-task-success",
    }),
    "correct-abstention": Object.freeze({
      predicate: "timely-valid-required-abstention-or-uncertainty-fully-satisfied",
      category: "substantive-success",
      cellSuccess: true,
      scoreEffect: "score-by-frozen-dimensions",
      denominatorRule: "retain",
    ...
    missing: Object.freeze({
      predicate: "cell-not-started-or-no-answer-artifact-at-cell-close",
      category: "availability-failure",
      cellSuccess: false,
      scoreEffect: "zero",
      denominatorRule: "retain",
      timeRule: "configured-answer-deadline",
      taskAggregation: "failed-cell",
      severeErrorRelation: "no-automatic-severe-error",
      decisionEffect: "block-this-arm-task-success",
    }),
    late: Object.freeze({
      predicate: "complete-valid-answer-after-answer-deadline-before-hard-timeout",
      category: "timing-failure",
      cellSuccess: false,
      scoreEffect: "zero",
      denominatorRule: "retain",
      timeRule: "actual-elapsed-through-valid-submission-uncapped",
      taskAggregation: "failed-cell",
      severeErrorRelation: "declared-severe-error-consequence-also-applies",
      decisionEffect: "block-this-arm-task-success",
    }),
    timeout: Object.freeze({
      predicate: "attempt-active-at-hard-timeout-without-complete-valid-answer",
      category: "timing-failure",
      cellSuccess: false,
      scoreEffect: "zero",
      denominatorRule: "retain",
      timeRule: "configured-hard-timeout",
      taskAggregation: "failed-cell",
      severeErrorRelation: "no-automatic-severe-error",
      decisionEffect: "block-this-arm-task-success",
    }),
    interrupted: Object.freeze({
      predicate: "attempt-ended-by-external-interruption-before-answer-deadline",
      category: "execution-failure",
      cellSuccess: false,
      scoreEffect: "zero",
      denominatorRule: "retain",
      timeRule: "actual-elapsed-through-interruption",
      taskAggregation: "failed-cell",
      severeErrorRelation: "no-automatic-severe-error",
      decisionEffect: "block-this-arm-task-success",
    }),
    invalid: Object.freeze({
      predicate: "unparseable-unattributable-or-protocol-invalid-result-without-contamination",
      category: "protocol-failure",
      cellSuccess: false,
      scoreEffect: "zero",
      denominatorRule: "retain",
      timeRule: "actual-elapsed-through-invalidity-or-hard-timeout-when-unobservable",
      taskAggregation: "failed-cell",
      severeErrorRelation: "declared-severe-error-consequence-also-applies",
      decisionEffect: "block-this-arm-task-success",
    }),
    contaminated: Object.freeze({
      predicate: "oracle-future-source-cross-arm-or-boundary-exposure-detected",
      category: "boundary-failure",
      cellSuccess: false,
      scoreEffect: "invalidate-cell",
      denominatorRule: "retain",
      timeRule: "actual-elapsed-through-detection-or-hard-timeout-when-unobservable",
      taskAggregation: "failed-cell",
      severeErrorRelation: "always-severe-boundary-error",
      decisionEffect: "force-stop",
    }),
  }),
});

export const expectedCaptureTax = Object.freeze({
  activities: captureTaxActivityIds,
  unit: "monotonic-elapsed-milliseconds",
  clock: "controller-monotonic-clock",
  interval: Object.freeze({
    startEvent: "first-graphtruth-only-work-start",
    endEvent: "last-graphtruth-only-verification-end",
    includeWaiting: true,
  }),
  manualInterventions: Object.freeze({
    counted: true,
    rule: "record-actual-operator-elapsed-time-under-one-required-activity",
  }),
  sharedGraphtruthWorkAllocation: Object.freeze({
    basis: "equal-across-benefiting-cells",
    rounding: "integer-milliseconds-largest-remainder-by-cell-id",
    taskAllocation: "sum-allocated-cell-shares",
    unallocatedRemainderAllowed: false,
  }),
  crossArmSharedWork: Object.freeze({
    rule: "exclude-only-identical-jointly-required-work-otherwise-attribute-to-benefiting-arm",
    evidenceRequired: true,
  }),
  attribution: Object.freeze({
    arm: "graphtruth",
    baselineCreditAllowed: false,
    futureAutomationCreditAllowed: false,
  }),
  endpointBinding: Object.freeze({
    primaryEndpoint:
      "successful-task-count-per-arm-then-median-total-elapsed-ms-including-graphtruth-capture-tax-per-successful-cell",
    medianTimeIncludesCaptureTax: true,
    alternative25PercentThresholdIncludesCaptureTax: true,
  }),
  incompleteLog: Object.freeze({
    resultClass: "invalid",
    timeRule: "configured-hard-timeout",
    decisionEffect: "block-keep",
  }),
  doubleCounting: Object.freeze({
    intervalIdentityRequired: true,
    maximumAttributionsPerInterval: 1,
    overlapRule: "split-overlap-before-single-attribution",
  }),
  budgetExhaustion: Object.freeze({
    resultClass: "invalid",
    decision: "stop",
    retryAllowed: false,
  }),
...
function validateOwnerAuthorizationRecord(value) {
  if (
    typeof value !== "string" ||
    !/^https:\/\/github\.com\/asukhodko\/graphtruth\/issues\/24#issuecomment-[1-9][0-9]*$/.test(value) ||
    nonAuthorizingRecords.includes(value)
  ) reject("OWNER_FREEZE_AUTHORIZATION");
  return value;
}
...
export function validateEvaluationContract(value, projectionLineCounts) {
  ...
  if (
    !hasExactKeys(value, [
      ...
      "baseline", "captureTax", "roles", "budgets", "severeErrorClasses", "decision",
  ...
  if (
    !hasExactKeys(value.comparison, [
      ...
      "answerDeadlineSecondsPerCell", "hardTimeoutSecondsPerCell",
    ]) ||
    ...
    value.comparison.answerDeadlineSecondsPerCell !== 600 ||
    value.comparison.hardTimeoutSecondsPerCell !== 630
  ) reject(code);
  if (
  ...
  if (
    !hasExactKeys(value.rubric, [
      "dimensions", "resultClassification", "severeErrorEffect", "cellSuccessRule",
  ...
  if (
    canonicalJson(value.rubric.resultClassification) !==
      canonicalJson(expectedResultClassification) ||
    value.rubric.severeErrorEffect !==
      "apply-declared-consequence-after-result-classification" ||
    value.rubric.cellSuccessRule !==
      "only-correct-or-correct-abstention-is-a-successful-cell" ||
    value.rubric.taskSuccessAggregation !==
      "an-arm-task-is-successful-iff-all-four-horizon-cells-are-successful" ||
    value.rubric.primaryEndpoint !==
      "successful-task-count-per-arm-then-median-total-elapsed-ms-including-graphtruth-capture-tax-per-successful-cell" ||
    value.rubric.medianTimePopulation !==
      "successful-cells-only-after-equal-successful-task-count" ||
    value.rubric.nonApplicableCounterevidenceRule !==
      "satisfied-only-when-oracle-explicitly-marks-not-applicable" ||
    value.rubric.disagreementProcedure !==
      "preserve-raw-scores-and-resolve-blind-before-arm-reveal"
  ) reject("AUTHOR_RUBRIC_INVALID");
  ...
  if (
    !hasExactKeys(value.baseline, [
      ...
      "answerDeadlineSecondsPerCell", "hardTimeoutSecondsPerCell",
      "maximumQueriesPerCell", "maximumAttemptsPerCell",
    ...
    value.baseline.maximumAttemptsPerCell !== 1 ||
    value.baseline.answerDeadlineSecondsPerCell !== 600 ||
    value.baseline.hardTimeoutSecondsPerCell !== 630 ||
  ...
  if (canonicalJson(value.captureTax) !== canonicalJson(expectedCaptureTax)) {
    reject("AUTHOR_CAPTURE_TAX_INVALID");
  }
...
export function validateAuditResult(value, expected) {
  ...
  for (const issue of value.issues) {
    if (
      ...
      !auditIssueCodesByChecklist[issue.checkId].includes(issue.code) ||
  ...
  return {
    ...
    ...objectSchema({
      ...
      comparison: objectSchema({
        ...
        answerDeadlineSecondsPerCell: { type: "integer", const: 600 },
        hardTimeoutSecondsPerCell: { type: "integer", const: 630 },
      }),
      ...
      rubric: objectSchema({
        ...
        resultClassification: { const: expectedResultClassification },
        severeErrorEffect: {
          type: "string", const: "apply-declared-consequence-after-result-classification",
        },
      ...
      captureTax: { const: expectedCaptureTax },
      roles: objectSchema({
  ...
  return {
    ...
    ...objectSchema({
      ...
      issues: {
        ...
        items: {
          oneOf: auditChecklistIds.map((checkId) => objectSchema({
            checkId: { type: "string", const: checkId },
            code: { type: "string", enum: auditIssueCodesByChecklist[checkId] },
          })),
        },
      },
...
export function buildAuthorPrompt(projectionItems, ownerAuthorizationRecord) {
  validateOwnerAuthorizationRecord(ownerAuthorizationRecord);
  const input = {
    protocol: "graphtruth.evaluation-freeze-author-input/2",
    ...
    controllerInstruction: [
      ...
      "Copy the exact structured result-classification and capture-tax contracts; do not paraphrase or omit a field.",
      "Fully specify blinding, first exposure, contamination and disagreement handling.",
    ],
    fixedIdentities: {
    ...
    requiredValidationConstants: {
      comparison: {
        ...
        answerDeadlineSecondsPerCell: 600,
        hardTimeoutSecondsPerCell: 630,
      },
      ...
      resultClassification: expectedResultClassification,
      captureTax: expectedCaptureTax,
...
export function buildAuditPrompt(
  ...
  return canonicalJson({
    protocol: "graphtruth.evaluation-freeze-audit-input/2",
    ...
    auditRequirements: [
      ...
      "The rubric exactly matches the closed ten-class classification contract, including precedence, one retained class per cell, time rules, task aggregation, severe-error relation and decision effects.",
      "The rg arm uses the exact binary and argv prefix, byte/horizon/task parity, no shell and one attempt.",
      "Capture tax exactly covers capture, annotation, correction, maintenance and verification, and binds its complete ledger to GraphTruth time, the primary endpoint, median time and the 25 percent alternative.",
      ...
      "On reject use exactly one predeclared issue code permitted for each failed checklist ID; include no prose, paths, quotations or private-derived values.",
...
async function verifyFrozenAudit(auditPath, expected) {
  ...
  if (
    ...
    manifest.documentKind !== "graphtruth.evaluation-freeze-audit-manifest/2" ||
    manifest.executionId !== expected.executionId ||
    manifest.coreManifestSha256 !== expected.coreManifestSha256 ||
    manifest.ownerAuthorizationRecord !== expected.ownerAuthorizationRecord ||
...
async function recordTerminal(privateRoot, executionId, code, callCount, extra = {}) {
  ...
  const record = await writeJsonExclusive(path.join(staging, "TERMINAL.json"), {
    documentKind: "graphtruth.evaluation-freeze-terminal/2",
    executionId,
    code,
...
function publicStatus(value) {
  const keys = [
    ...
    "releaseSha256", "terminalSha256", "auditDecision", "auditChecklist",
    "auditIssues", "repairPerformed", "runPerformed", "retryAllowed",
    "resumeAllowed", "counts", "modelCalls",
  ...
  if (
    !hasExactKeys(value.auditChecklist, auditChecklistIds) ||
    Object.values(value.auditChecklist).some((flag) => typeof flag !== "boolean") ||
    !Array.isArray(value.auditIssues) || value.auditIssues.length > auditChecklistIds.length ||
    value.repairPerformed !== false || value.runPerformed !== false ||
    value.retryAllowed !== false || value.resumeAllowed !== false
  ) reject("PUBLIC_STATUS_INVALID");
  const publicIssueChecks = new Set();
  for (const issue of value.auditIssues) {
    if (
      !hasExactKeys(issue, ["checkId", "code"]) ||
      !auditChecklistIds.includes(issue.checkId) ||
      !auditIssueCodesByChecklist[issue.checkId].includes(issue.code) ||
      publicIssueChecks.has(issue.checkId)
    ) reject("PUBLIC_STATUS_INVALID");
    publicIssueChecks.add(issue.checkId);
  }
  const failed = auditChecklistIds.filter((id) => value.auditChecklist[id] === false);
  if (
    (value.auditDecision === "accept" && (failed.length !== 0 || value.auditIssues.length !== 0)) ||
    (value.auditDecision === "reject" && (
      failed.length === 0 || failed.length !== value.auditIssues.length ||
      failed.some((id) => !publicIssueChecks.has(id))
    ))
  ) reject("PUBLIC_STATUS_INVALID");
  return value;
}
...
export async function runEvaluationFreeze(options, dependencyOverrides = {}) {
  ...
  const ownerAuthorizationRecord = validateOwnerAuthorizationRecord(
    options.ownerAuthorizationRecord,
  );
  ...
  await writeJsonExclusive(path.join(privateRoot, "00-intent.json"), {
    documentKind: "graphtruth.evaluation-freeze-intent/2",
    executionId,
    experimentId: evaluationExperimentId,
    projectionId: evaluationProjectionId,
    ownerAuthorizationRecord,
  ...
  const authorPrompt = buildAuthorPrompt(projection.items, ownerAuthorizationRecord);
  ...
  await writeJsonExclusive(path.join(privateRoot, "02-AUTHOR-CALL_CONSUMED.json"), {
    documentKind: "graphtruth.evaluation-freeze-call-consumed/2",
  ...
  const splitArtifacts = {
    "evaluation-contract.json": {
      documentKind: "graphtruth.evaluation-contract-core/2",
      ...
      captureTax: contract.captureTax,
    ...
    "tasks.json": {
      documentKind: "graphtruth.evaluation-task-pack/2",
      experimentId: contract.experimentId,
    ...
    "oracle.json": {
      documentKind: "graphtruth.evaluation-oracle/2",
      experimentId: contract.experimentId,
    ...
    "cells.json": {
      documentKind: "graphtruth.evaluation-denominator/2",
      experimentId: contract.experimentId,
      cells: contract.tasks.flatMap((task) =>
        task.cells.map((cell) => ({ taskId: task.taskId, ...cell }))),
    },
    "run-card.json": {
      documentKind: "graphtruth.evaluation-run-card/2",
      experimentId: contract.experimentId,
  ...
  splitArtifacts["artifact-roles.json"] = {
    documentKind: "graphtruth.evaluation-artifact-roles/2",
    experimentId: contract.experimentId,
    artifacts: [
  ...
  const coreManifest = {
    documentKind: "graphtruth.evaluation-freeze-core-manifest/2",
    executionId,
    experimentId: evaluationExperimentId,
    projectionId: evaluationProjectionId,
    projectionManifestSha256: acceptedProjectionManifestSha256,
  ...
  const safeAuditChecklist = Object.fromEntries(
    auditChecklistIds.map((id) => [id, audit.checklist[id]]),
  );
  const safeAuditIssues = auditChecklistIds.flatMap((checkId) => {
    const issue = audit.issues.find((candidate) => candidate.checkId === checkId);
    return issue === undefined ? [] : [{ checkId, code: issue.code }];
  });
  if (canonicalJson(await captureToolchainIdentity(rgIdentity)) !== canonicalJson(toolchain)) {
    reject("TOOLCHAIN_CHANGED");
  }
  ...
  const auditManifest = {
    documentKind: "graphtruth.evaluation-freeze-audit-manifest/2",
    executionId,
    coreManifestSha256: coreManifestRecord.sha256,
    ownerAuthorizationRecord,
  ...
  if (audit.decision === "reject") {
    ...
    const terminalRecord = await recordTerminal(
      ...
      callCount,
      {
        ...
        auditManifestSha256: auditManifestRecord.sha256,
        auditResultSha256: auditRecord.sha256,
        auditChecklist: safeAuditChecklist,
        auditIssues: safeAuditIssues,
        repairPerformed: false,
        runPerformed: false,
        retryAllowed: false,
        resumeAllowed: false,
    ...
    return publicStatus({
      documentKind: "graphtruth.evaluation-freeze-public-status/2",
      status: "rejected",
...
export function parseArguments(arguments_) {
  if (!Array.isArray(arguments_) || arguments_.length !== 16) reject("USAGE");
  if (
    ...
    arguments_[12] !== "--owner-freeze-authorization-record" ||
    arguments_[14] !== "--confirm-openai-processing-authorized" ||
    arguments_[15] !== "--confirm-no-run-authorized"
  ) reject("USAGE");
  ...
  validateOwnerAuthorizationRecord(arguments_[13]);
  return {
    ...
    ownerAuthorizationRecord: arguments_[13],
...
async function main() {
  ...
  try {
    ...
    process.stderr.write(
      "usage: codex-evaluation-freeze-v2 --repository ABS --projection ABS --private-root ABS " +
      "--codex ABS --auth-carrier ABS --rg /opt/homebrew/bin/rg " +
      "--owner-freeze-authorization-record ISSUE_24_COMMENT_URL " +
  ...
  try {
    ...
    process.stderr.write(`codex-evaluation-freeze-v2: rejected (${code})\n`);
    process.exitCode = 1;
  }
}
