...
const manifestRelativePath =
  "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/EXECUTION-PACK-MANIFEST.json";
const auditRelativePath =
  "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/PACK-AUDIT-RESULT.json";
const decoder = new TextDecoder("utf-8", { fatal: true });
const sha256Pattern = /^[a-f0-9]{64}$/;

export const executionPackIdentity =
  "author-call-result-schema-exploratory-learning-execution-pack-v2";
...
export const executionPackFileContract = Object.freeze([
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/README.md",
    role: "pack-documentation",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/RUN-CARD.template.md",
  ...
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/SAFE-RESULT.schema.json",
    role: "safe-result-schema",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/SYNTHETIC-TRACE.jsonl",
    role: "synthetic-positive-fixture",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/fixtures/negative/duplicate-key-jsonl.jsonl",
    role: "negative-fixture",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/fixtures/negative/leaking-result.json",
    role: "negative-fixture",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/fixtures/negative/malformed-jsonl.jsonl",
    role: "negative-fixture",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/fixtures/negative/missing-final-message.jsonl",
    role: "negative-fixture",
    mode: "0644",
  }),
  Object.freeze({
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v2/fixtures/negative/tool-event-jsonl.jsonl",
    role: "negative-fixture",
    mode: "0644",
  }),
  Object.freeze({
    path: "tooling/author-call-result-schema-learning-v2",
    role: "reader-wrapper",
    mode: "0755",
  }),
  Object.freeze({
    path: "tooling/author-call-result-schema-learning-v2-validator.mjs",
    role: "semantic-validator",
    mode: "0644",
  }),
  Object.freeze({
    path: "tooling/author-call-result-schema-learning-v2-verifier.mjs",
    role: "independent-verifier",
    mode: "0644",
  }),
  Object.freeze({
    path: "tooling/author-call-result-schema-learning-v2.mjs",
    role: "one-use-reader",
    mode: "0644",
  }),
  Object.freeze({
    path: "tooling/author-call-result-schema-learning-v2.test.mjs",
    role: "mutation-tests",
    mode: "0644",
  }),
]);
...
export const executionPackAnchorContract = Object.freeze([
  ...
  Object.freeze({
    id: "boundary",
    path:
      "examples/experiments/author-call-qualification-v1/EXPLORATORY-LEARNING-BOUNDARY-V2.md",
  ...
  Object.freeze({
    ...
    sha256: "4065f91cd930181eae6eeed520b978fb31361b636944e4bed4b8b7b11b02d58e",
    exports: Object.freeze([]),
  }),
  Object.freeze({
    id: "priorExecutionPackManifest",
    path:
      "examples/experiments/author-call-qualification-v1/exploratory-learning-v1/EXECUTION-PACK-MANIFEST.json",
    sha256: "205d1bcc3fe7e4331ef209c93cd07e61ddaecf2e37d1428e19c9afaa29312ab4",
    exports: Object.freeze([]),
  }),
  Object.freeze({
    id: "priorPackAudit",
    ...
    sha256: "5257e6229e2eacd15fdd2df655c6a3db00d394e94b660100dac0564cb9f237f4",
    exports: Object.freeze([]),
  }),
  Object.freeze({
...
export const executionPackMutationMatrix = Object.freeze([
  ...
  "no-retry",
  "one-protected-pass",
  "no-control-card-read",
  "prior-v1-lineage-tamper",
  "leak-instruction",
  "leak-path",
  "leak-error-text",
  "undeclared-field",
...
function validateReaderSource(source, errors) {
  ...
  if (
    ...
    count("await readdir(workRoot)") !== 1 ||
    count("readdir(") !== 1 ||
...
function validateVerifierSource(source, errors) {
  ...
  if (
    /from\s+"\.\/author-call-result-schema-learning-v2(?:\.mjs)?"/.test(source) ||
    /import\s*\(\s*["']\.\/author-call-result-schema-learning-v2/.test(source)
  ) {
...
export function verifyExecutionPackEvidence(evidence, expectedManifestSha256) {
  ...
  validateReaderSource(text("tooling/author-call-result-schema-learning-v2.mjs"), errors);
  validateValidatorSource(
    text("tooling/author-call-result-schema-learning-v2-validator.mjs"),
    errors,
  );
  validateVerifierSource(
    text("tooling/author-call-result-schema-learning-v2-verifier.mjs"),
    errors,
  );
  validateTestSource(text("tooling/author-call-result-schema-learning-v2.test.mjs"), errors);
  ...
  const verifierPath = "tooling/author-call-result-schema-learning-v2-verifier.mjs";
  return {
    documentKind:
...
async function main() {
  if (
    ...
    process.stderr.write(
      "usage: node author-call-result-schema-learning-v2-verifier.mjs --manifest-sha256 SHA256\n",
    );
    process.exitCode = 2;
    return;
  }
