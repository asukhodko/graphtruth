...
export const exploratoryLearningSubjectIdentity =
...
export const acceptedLearningAnchors = Object.freeze({
  ...
  priorExecutionPackManifest: Object.freeze({
    path:
...
const expectedFixedSubject = Object.freeze({
  identity: exploratoryLearningSubjectIdentity,
...
const expectedPackFiles = Object.freeze([
  ...
  "tooling/author-call-result-schema-learning-v2",
  "tooling/author-call-result-schema-learning-v2-validator.mjs",
  "tooling/author-call-result-schema-learning-v2-verifier.mjs",
  "tooling/author-call-result-schema-learning-v2.mjs",
  "tooling/author-call-result-schema-learning-v2.test.mjs",
]);
  ...
  try {
    ...
    const code =
      error instanceof ExploratoryLearningReaderError
        ? error.code
        : "UNEXPECTED_FAILURE";
    process.stderr.write(`author-call-result-schema-learning-v2: rejected (${code})\n`);
    process.exitCode = 1;
  }
}
